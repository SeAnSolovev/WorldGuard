...
public class RegionPrintoutBuilder implements Callable<TextComponent> {
    ...
    public void appendDomain() {
        ...
        builder.append(TextComponent.of("Пользователи: ", TextColor.BLUE));
    ...
    private void appendRegionInformation() {
        ...
        if (cache != null && perms == null) {
            builder.append(SubtleFormat.wrap("Имена, помеченные *, — это последние известные имена и могут быть неактуальными."));
        }
    }
