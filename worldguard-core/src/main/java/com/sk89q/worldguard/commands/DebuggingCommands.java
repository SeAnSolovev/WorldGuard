...
public class DebuggingCommands {
    ...
    @Command(aliases = {"testbreak"}, usage = "[игрок]", desc = "Смоделировать ломание блока", min = 1, max = 1, flags = "ts")
    ...
    @Command(aliases = {"testplace"}, usage = "[игрок]", desc = "Смоделировать установку блока", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testinteract"}, usage = "[игрок]", desc = "Смоделировать взаимодействие с блоком", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testdamage"}, usage = "[игрок]", desc = "Смоделировать урон сущности", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
