...
public class ProtectedCuboidRegion extends ProtectedRegion {
    ...
    public void setMinimumPoint(BlockVector3 position) {
        WorldGuard.logger.warning("Вызов ProtectedCuboidRegion#setMinimumPoint проигнорирован. Изменение регионов может привести к непредсказуемому поведению.");
    }
    ...
    public void setMaximumPoint(BlockVector3 position) {
        WorldGuard.logger.warning("Вызов ProtectedCuboidRegion#setMaximumPoint проигнорирован. Изменение регионов может привести к непредсказуемому поведению.");
    }
