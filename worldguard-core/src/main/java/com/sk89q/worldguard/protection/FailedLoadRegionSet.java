...
public class FailedLoadRegionSet extends AbstractRegionSet {
    ...
    private final String denyMessage = "Данные регионов WorldGuard не удалось загрузить для этого мира, поэтому " +
            "всё было защищено в качестве меры предосторожности. Пожалуйста, сообщите об этом администратору сервера.";
